...
:_public_repo_url: https://github.com/decidim/docs-config-tutorial.git

// MANDATORY. Title of the document. In web format, It appears as a heading of
// level 1. In PDF format, it appears in a title page.
:doctitle: Tutorial de configuración de Decidim

// OPTIONAL. Subtitle of the document.
:_subtitle: Guía de inicio para administradoras
...
// below.
:authors: María Becedas, Mariola Ruiz, Joan Olivé

// OPTIONAL. See this field description in file CONTRIBUTING.adoc.
// below.
:_editors: Mariola Ruiz, Joan Olivé

// OPTIONAL. See this field description in file CONTRIBUTING.adoc.
// below.
:_contributors: Núria Alonso

// OPTIONAL. See this field description in file CONTRIBUTING.adoc.
// below.
:_proofreaders: Juan Linares, Guillem Marpons
...
:_summary: Este documento es una guía práctica para configurar una instancia de Decidim con los elementos básicos para que sea operativa, incluyendo: procesos, asambleas e iniciativas. No pretende ser una referencia exhaustiva de todas las funcionalidades de Decidim y no incluye la instalación del software.

// MANDATORY. Comma-separated list of terms to help classifying and searching
// the document. In web format, this terms are integrated as SEO enabling
// metadata. In PDF format, they are shown near the other metadata.
:keywords: decidim, democracia participativa, software libre, código abierto, ciudades, organizaciones, administración, guía de inicio

// OPTIONAL. Document's history.
:_dochistory: Inicialmente, María Becedas, de Ethicoo, impartió un http://curso.localret.codegram.com/[curso de administración de Decidim]: Becedas, M.A. ethicoo.org (2018), Proceso formativo para el diseño de procesos participativos con Decidim. Núria Alonso adaptó los materiales del curso inicial para un curso impartido a municipios de la Diputación de Barcelona. Finalmente, Mariola Ruiz y Joan Olivé reescribieron los contenidos en Asciidoc y con capturas de pantalla actualizadas.
...
:_citation: {authors} ({docyear}), {doctitle}, v{revnumber}
