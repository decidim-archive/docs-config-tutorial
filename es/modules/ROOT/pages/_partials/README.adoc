...
:_dochistory: Inicialmente María Becedas, de Ethicoo, impartió un curso de administración de Decidim. Núria Alonso adaptó los materiales del curso inicial para un curso impartido a municipios de la Diputación de Barcelona. Finalmente Mariola Ruiz y Joan Olivé reescribieron los materiales en Asciidoc y con capturas de pantalla actualizadas.
