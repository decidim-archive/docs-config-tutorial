...
:doctitle: Decidim's Configuration Tutorial
...
:_summary: This document is a practical guide to set up a Decidim instance with the basic elements to be operational, including: processes, assemblies, and initiatives. It does not pretend to be an exhaustive reference for all the functionalities of Decidim, and it does not include the installation of the software.

// MANDATORY. Comma-separated list of terms to help classifying and searching
// the document. In web format, this terms are integrated as SEO enabling
// metadata. In PDF format, they are shown near the other metadata.
:keywords: decidim, participatory democracy, free software, open source, cities, organizations, administration, startup guide

// OPTIONAL. Document's history. Do not intercalate empty lines.
:_dochistory: Initially, María Becedas from Ethicoo http://curso.localret.codegram.com/[imparted a course on administering Decidim]: Becedas, M.A. ethicoo.org (2018), Proceso formativo para el diseño de procesos participativos con Decidim. Núria Alonso then adapted those materials for a course imparted to municipalities of the Diputació de Barcelona. Finally, Mariola Ruiz and Joan Olivé rewrote the materiarials in Asciidoc and added updated screenshots.
